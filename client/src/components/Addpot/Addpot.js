      ...
      <form action="https://formbold.com/s/FORM_ID" method="POST">
        ...
        <div className="fer">
          <div>
            ...
            <input onChange={(e) => setdescription(e.target.value)} type="email" name="email" id="email" className="formbold-form-input" />
          </div>
          <div>
            <label htmlFor="email" className="formbold-form-label"> totale</label>
...
<div className="custom-form-item-unique">
        ...
        <button className="formbold-btn">Ajouter un pot </button>
      </form>
    </div>
  </div>
